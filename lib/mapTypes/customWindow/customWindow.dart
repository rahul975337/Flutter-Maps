...
import 'package:maps/mapTypes/customWindow/pin_pill_info.dart';
...
class CustomWindow extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CustomWindowState();
}

class CustomWindowState extends State<CustomWindow> {
